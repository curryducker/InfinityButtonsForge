...
public class SoulBambooWallTorchLever extends PropelWallTorchLever {
    public SoulBambooWallTorchLever(Properties properties, Block jadeBlock) {
        super(properties, jadeBlock);
    }

    @Override
    public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
        return new ArrayList<>(Collections.singleton(new ItemStack(BambooBlocksItems.SOUL_BAMBOO_TORCH_LEVER.get())));
    }
}
